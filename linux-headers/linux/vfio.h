 ...
 * returns an estimate of the current data sizes remaining to be transfered. It
 * allows the user to judge when it is appropriate to leave PRE_COPY for
 * STOP_COPY.
 *
 ...
 * transfered to complete the migration. Generally it should start as zero
